...
namespace app {
	...
	struct Config {
		...
		std::function<void(SDL_Event&)> doEventCB;
...
namespace util {
	...
	void loadBlob(std::string path, std::vector<char>& data);
...
namespace vk {
	struct Vulkan {
		...
		// Render Passes
		VkRenderPass renderPass; // This is used to clear the screen
		// Framebuffers
		std::vector<VkFramebuffer> framebuffer;
		// Command Pool
		VkCommandPool commandPool;
		// Semaphores
		std::vector<VkSemaphore> submitCB;
		std::vector<VkSemaphore> submitPresentQueue;
		// Fence
